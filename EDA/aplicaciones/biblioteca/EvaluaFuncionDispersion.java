    ...
    public static void main(String[] args) {
        ...
        try {
            ...
            for (fdis = 0; fdis < Termino.NOMFDIS.length; fdis++) {  
				...
				TablaHash<Termino,Termino> hash = construirTabla("lista10.txt",fdis);
				
                //2.- Mostrar por pantalla los valores de factor de carga y desviacion tipica
                
				System.out.println("FC " + hash.factorCarga() + "DT " + hash.desviacionTipica());            
